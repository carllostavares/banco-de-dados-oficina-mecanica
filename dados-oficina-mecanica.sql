...
("070.154.874-57",20,"6ER775KJ58G444441","2023-04-11","2023-04-12", 299.99),
("112.345.678-90",21,"0RH887MK89D566667","2023-04-20","2023-04-22", 159.00),
("777.888.999-34",22,"6AS771YI38J111478","2023-04-02", "2023-04-05", 200.00),
("014.128.358-00",24,"2ZL66WS05D5339334","2023-04-10","2023-04-10",151.00),
("055.432.798-57",23,"3WM991QA07L668230","2023-04-15","2023-04-16",1984.96),
("077.188.387-02",23,"0ED889HU65Q151545","2023-05-15","2023-05-17",200.00),

("120.749.910-88",24,"","2023-05-23","2023-05-23",19.99),
("100.300.650-76",24,"","2023-05-23","2023-05-25",69.99),
("112.088.387-02",21,"","2023-05-25","2023-05-25",79.80)
;
...
INSERT INTO tb_formapagamento (id_pagamento, tipo_pagamento, qtd_parcelas,valor_pagamento,id_os) VALUES 	
		...
		("4", "pix",0,149.00,4),
		("5", "pix" ,0,399.90,5),
		("6", "especie",0,620.00,6),
		("7", "pix",0,269.99,7),
		("8", "especie",0,524.0,8),
		("9", "credito", 3,491.98,9),
		("10", "debito",0,749.99,10),
		("11", "pix",0,183.0,11),
		("12", "debito",0,599.99,12),
		("13", "especie",0,299.99,13),
		("14", "pix",0,159.00,14),
		("15", "especie",0,200.0,15),
		("16", "pix",0,151.00,16),
		("17", "pix",0,1984.94,17),
		("18", "credito",5,200.00,18),
		("19", "credito",1,19.99,19),
		("20", "pix",0,69.99,20),
		("21", "debito",0,79.80,21);
